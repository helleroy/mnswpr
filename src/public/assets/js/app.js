    ...
    generateBoard: function () {
        ...
        for (var i = 0; i <= this.props.size.height; i++) {
            ...
            for (var j = 0; j <= this.props.size.width; j++) {
                row.push(React.createElement(Tile, {key: this.props.size.height + this.props.size.width}))
            }
            tiles.push(row);
        }
...
},{"../tile/Tile":159,"react":157}],159:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function () {
        return (
            React.createElement("div", {onClick: this.reveal}, 
                this.state.revealed ? React.createElement("div", null, "[]") : React.createElement("div", null, "[X]")
            )
        );
    }
})
